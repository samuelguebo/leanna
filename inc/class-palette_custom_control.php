	  ...
	  public function render_content()
	   {
			?>  <style>
				...
				<label>
				  ...
				  <div id="palette">
					<!-- lavender -->
					<a id="lavender" href="#" <?php if($current_color == 'lavender') echo $selected_css;?>>
					<input type="radio" name="<?php echo $this->id; ?>" <?php $this->link(); ?> id="<?php echo $this->id; ?>" value="lavender" />
					</a>
