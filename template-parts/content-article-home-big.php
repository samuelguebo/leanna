...
/*
================================================================================================
Template part for displaying articles in loop (Home Big)
================================================================================================
@package        Leanna
...
<article id="post-<?php the_ID(); ?>" class="post-item <?php echo $container_class;?> columns big">
    <!--post/-->
    <div class="post-item-caption">
        ...
        <div class="panel">
            ...
            <p><?php echo leanna_new_excerpt_length(200);?></p> 
        </div>
    </div>
</article>
